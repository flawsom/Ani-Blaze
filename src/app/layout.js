...
const APP_NAME = "Aniblaze";
const APP_DEFAULT_TITLE = "Aniblaze - Watch Anime Online";
const APP_DESCRIPTION = "Explore a vast collection of anime on Aniblaze, your go-to destination for streaming the latest and classic anime series. Immerse yourself in captivating storylines, vibrant animation, and diverse genres. Discover a world of entertainment at your fingertips with Aniblaze, where every episode is an adventure.";

export const metadata = {
  metadataBase: new URL('https://Aniblaze-next.vercel.app'),
